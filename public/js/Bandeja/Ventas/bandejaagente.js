...
$(document).ready(function(){
    ...
    var tablaDatos = $("#tablaDatos");
     ...
     var route = "http://192.168.1.105/agendadatos";
    ...
    $.get(route, function(res){
        ...
        var agendados = value.agendados;
          ...
          /*  $(agendados).each(function (index,value){
                var hora = value.horas;
              
                //console.log(hora);
                tablaDatos.append("<tr><td>"+value.cedula+"</td><td>"+value.nombres+"</td><td>"+value.campanadescripcion+"</td><td>"+value.telefonoNuevo+"</td><td>"+value.fecha+"</td><td>"+hora+"</td><td style='width: 5px'> <a href='http://damplus.net/agendadatos/show/"+value.cedula+"/"+value.campana+"' class='btn btn-sm btn-info'><i class='fa fa-eye'></i></a></td></tr>");
